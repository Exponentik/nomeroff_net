...
from OCR.image_loaders import BaseImageLoader
from OCR.pipelines.base import Pipeline, CompositePipeline, empty_method
...
from OCR.tools.image_processing import (crop_number_plate_zones_from_images,
                                                 crop_number_plate_roi_zones_from_images,
                                                 group_by_image_ids)
from OCR.tools import unzip
from OCR.pipes.number_plate_keypoints_detectors.bbox_np_points_tools import (normalize_rect_new,
                                                                                      normalize_rect)
